...
# Type: Register protocol "ResearchOutput" fields in type checker
__type_checker.register_protocol_field("ResearchOutput", "summary", AliasTypeExpr("Any"))
__type_checker.register_protocol_field("ResearchOutput", "key_points", AliasTypeExpr("Any"))

class SummaryResult(pydantic.BaseModel):
    title: str
    abstract: str

# Type: Register protocol "SummaryResult" fields in type checker
__type_checker.register_protocol_field("SummaryResult", "title", AliasTypeExpr("Any"))
__type_checker.register_protocol_field("SummaryResult", "abstract", AliasTypeExpr("Any"))
...
Researcher = NexaAgent(
    ...
    tools=[]
,
    context_spec={"type": "ContextDecl", "source": "upstream", "sink": "downstream", "input_schema": null, "output_schema": "ResearchOutput", "max_history_turns": 10, "inherit": ["messages"]}
)
...
Summarizer = NexaAgent(
    ...
    tools=[]
,
    context_spec={"type": "ContextDecl", "source": "upstream", "sink": "downstream", "input_schema": "ResearchOutput", "output_schema": "SummaryResult", "max_history_turns": 5, "inherit": ["messages", "artifacts"]}
)

def flow_main():
    print("=== v2.2.1 Context-as-Structure Demo ===")
    result = nexa_context_pipeline("quantum computing breakthroughs 2024", [  ])
    print(result)
    return result
