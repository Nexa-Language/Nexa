...
> **给 AI Agent 的指令**: 按照本文档的步骤，在你的环境中安装 Nexa v2.0 并运行第一个程序。
...
如果输出 `Nexa v2.0.0` 和 `Nexa 安装成功!`，则安装完成。
...
agent HarnessBot {
    role: "智能助手",
    model: "gpt-4o-mini",
    prompt: "你是一个展示 Nexa v2.0 Harness 能力的助手"
}

flow main {
    print("=== Nexa v2.0 Harness Demo ===");
...
1. **阅读 Agent 指南**: 查看 [`AGENT_GUIDE.md`](AGENT_GUIDE.md) 学习 Nexa v2.0 完整语法
...
*本文档专为 AI Agent 设计，帮助快速安装和验证 Nexa v2.0 语言。*